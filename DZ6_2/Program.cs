...
double pointX;
double pointY;
Console.Write("Введите через пробел по очереди b1, k1, b2 и k2 одной строкой: ");
...
if (a == b)
{
    Console.Write("По формулаам y = k1 * x + b1, y = k2 * x + b2");
    Console.WriteLine("\n Прямые с такими параметрами паралельны");
}
else
{
